...
const NotificationsPage = () => {
  ...
  return (
    <div className="space-y-6 hide-scrollbar max-h-[80vh] overflow-y-scroll sidebar-scrollbar">
      {/* Header */}
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-4 w-80 border border-primary-color1 dark:border-primary-color1/60 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                value={searchTerm}
        ...
        <Card className="shadow-sm border-gray-200 dark:border-gray-700 ">
          <CardHeader className="border-b border-gray-200 dark:border-gray-700">
            <CardTitle className="flex items-center gap-3 text-gray-900 dark:text-white">
              <div className="p-2 bg-primary-color1/10 dark:bg-primary-color1/20 rounded-lg">
