      ...
      {statCards.map((stat) => {
        ...
        return (
          <Col xs={24} sm={12} lg={6} key={stat.key}>
            <div
              className={`group relative overflow-hidden rounded-2xl bg-white border-2 ${stat.borderColor} shadow-md hover:shadow-xl transition-all duration-500 hover:-translate-y-2 cursor-pointer`}
            >
