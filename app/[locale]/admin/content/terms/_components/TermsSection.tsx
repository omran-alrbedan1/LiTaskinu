// components/admin/terms/TermsSection.tsx
...
// Import the type (if using separate types file)
// import { TermsSectionType } from "@/types/terms";

// Or use the interface from the hook
...
interface TermsSectionProps {
  ...
  onUpdate: (id: string, field: keyof TermsSectionType, value: string) => void;
