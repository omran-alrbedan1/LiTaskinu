...
const FIELD_OPTIONS = {
  ...
  wearNigab: ["Any", "Yes", "Sometimes", "No"],
  wearHijab: ["Any", "Yes", "Sometimes", "No"],
  polygamy: [
    "Any",
    "Accept polygamy",
  ...
  attendReligiousServicesDetailed: [
    "Any",
    "Only During Ramadan",
    "Daily",
    "Never",
    "Only on Jumu'ah / Fridays",
    "Sometimes",
  ],
  readQuranDetailed: ["Daily", "Weekly", "Monthly", "Rarely", "Never"],
};
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Religion",
        type: "radio",
        options: FIELD_OPTIONS.religion,
      },
      {
        key: "wearHijab",
        label: "Do they wear a Hijab?",
        type: "radio",
        options: FIELD_OPTIONS.wearHijab,
      },
      {
        key: "wearNigab",
        label: "Do they wear a Nigab?",
        type: "radio",
        options: FIELD_OPTIONS.wearNigab,
      },
      {
        key: "readQuranDetailed",
        label: "Read Quran",
        type: "radio",
        options: FIELD_OPTIONS.readQuranDetailed,
      },
      {
        key: "polygamy",
        label: "Polygamy",
        type: "radio",
        options: FIELD_OPTIONS.polygamy,
      },
      {
        key: "familyValuesDetailed",
        label: "Family Values",
        type: "radio",
        options: FIELD_OPTIONS.familyValuesDetailed,
      },
      {
        key: "profileCreator",
      ...
      {
        key: "attendReligiousServicesDetailed",
        label: "Attend Religious Services",
        type: "radio",
        options: FIELD_OPTIONS.attendReligiousServicesDetailed,
      },
      {
        key: "languagesSpoken",
