...
export default function ChatPage() {
  const t = useTranslations("psychiatrist_detail.chat");
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    {doctor.isOnline ? t("status.online") : t("status.offline")}
                    {doctor.typing && <span className="text-primary-color1 ml-2">• {t("status.typing")}</span>}
                  </p>
                </div>
              </div>
            </div>
                          ...
                          <div className="flex-1 min-w-[120px]">
                            <div className="flex items-center justify-between mb-1">
                              <span className="text-xs font-medium">
                                {msg.sender === 'user' ? t("messageTypes.userVoice") : t("messageTypes.doctorVoice")}
                              </span>
