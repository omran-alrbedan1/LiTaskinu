...
const Footer = async () => {
  ...
  const contactItems = [
    { icon: <FaLocationDot className="text-xl" />, text: "" },
    {
      icon: <MdOutlineMail className="text-xl" />,
      text: "",
    },
    { icon: <Smartphone className="text-xl" />, text: "" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 md:gap-10">
          <div className="space-y-4 md:mr-8 md:space-y-6">
            ...
            <p className="text-gray-600  dark:text-gray-300 text-xs text-center md:text-sm leading-relaxed  md:text-center">
              ...
              Obcaecati, maxime. Suscipit, consectetur, deleniti corporis atque
              reprehenderit tempore qui distinctio dolorem rerum placeat, eum
              repellat soluta quis omnis. Minima, officia mollitia.
            </p>
